...
const MyProfile = () => {
    ...
    return (
        <>
            ...
            {/* 1st Section */}
            <div className="flex items-center justify-between rounded-md border-[1px] border-richblue-300 bg-richblue-400 p-8 px-12">
            ...
            {/* Section 2 */}
            <div className="my-10 flex flex-col gap-y-10 rounded-md border-[1px] border-richblue-300 bg-richblue-400 p-8 px-12">
