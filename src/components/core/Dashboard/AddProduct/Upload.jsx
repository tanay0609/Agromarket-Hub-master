...
export default function Upload({
    ...
    return (
        <div className="flex flex-col space-y-2">
            ...
            <div
                className={`${isDragActive ? "bg-richblue-300" : "bg-richblue-300"
                    } flex min-h-[250px] cursor-pointer items-center justify-center rounded-md border-[1px] border-richblue-200`}
            >
                {previewSource ? (
                    ...
                    >
                        ...
                        <div className="grid aspect-square w-14 place-items-center rounded-full bg-white">
                            <FiUploadCloud className="text-2xl text-richblack-700" />
                        </div>
